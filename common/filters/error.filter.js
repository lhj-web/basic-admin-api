...
let HttpExceptionFilter = class HttpExceptionFilter {
        ...
        const status = ((_a = exception.getStatus) === null || _a === void 0 ? void 0 : _a.call(exception)) || common_1.HttpStatus.INTERNAL_SERVER_ERROR;
        ...
        const data = {
            ...
            error: (errorInfo === null || errorInfo === void 0 ? void 0 : errorInfo.message) ||
