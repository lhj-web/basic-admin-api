...
export declare const HTTP_MESSAGE = "__customHttpMessage__";
...
export declare const HTTP_RES_TRANSFORM_PAGINATE = "__customHttpResTransformPagenate__";
...
export declare const AUTHORIZE_KEY_METADATA = "admin:authorize";
export declare const PERMISSION_OPTIONAL_KEY_METADATA = "admin:permission_optional";
